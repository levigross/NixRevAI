...
in
  stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchzip {
      ...
      in "https://github.com/NationalSecurityAgency/ghidra/releases/download/Ghidra_${finalAttrs.version}_build/ghidra_${finalAttrs.version}_PUBLIC_${versiondate}.zip";
    ...
    passthru.withExtensions = extensions: let
